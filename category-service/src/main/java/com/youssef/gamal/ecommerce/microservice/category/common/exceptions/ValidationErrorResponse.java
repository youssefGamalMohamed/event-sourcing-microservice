...
public class ValidationErrorResponse extends ErrorResponse {
    ...
    @Schema(
            ...
            example = ServiceErrorCodesConstants.CATEGORY_REQUEST_BODY_FAILED_VALIDATION
    )
    private String serviceErrorCode = ServiceErrorCodesConstants.CATEGORY_REQUEST_BODY_FAILED_VALIDATION;
}
