...
@Schema(
        ...
        description = "Response returned when a conflict occurs, e.g., category name already exists"
)
public class ConflictErrorResponse extends ErrorResponse {
    ...
    @Schema(
            ...
            example = ServiceErrorCodesConstants.CATEGORY_ALREADY_EXIST
    )
    private String serviceErrorCode = ServiceErrorCodesConstants.CATEGORY_ALREADY_EXIST;
}
